...
#define SOS D2
#define SLEEP_PIN D3 // Make this pin HIGH to make A9G board to go to sleep mode

String SOS_NUM = "+85517951607"; // Add a number on which you want to receive call or SMS
